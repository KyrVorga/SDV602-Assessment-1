...
def show_status_text(to_show, initial_text=None):
    ...
    if initial_text is not None:
        text_list.append(textwrap.fill(initial_text, 35))
        text_list.append('\n\n')
    ...
    match to_show:
        case 'story':
            if not cm.game_places[cm.game_location]['visited']:
                ...
                text_list.append(textwrap.fill(cm.game_places[cm.game_location]['story'], 35))
            else:
                text_list.append(textwrap.fill(cm.game_places[cm.game_location]['visited message'], 35))
            ...
            if "enemy" in cm.game_places[cm.game_location]:
                ...
                if not com.game_enemies[location_enemy]["defeated"]:
                    text_list.append('\n\n')
                    text_list.append(textwrap.fill(com.game_enemies[location_enemy]["description"], 35))
        ...
        case 'inventory':
            ...
            for item in im.game_items:
                if im.game_items[item]['acquired']:
                    ...
                    text_list.append('\n')
                    text_list.append(textwrap.fill(im.game_items[item]['description'], 35))
                    text_list.append('\n\n')
